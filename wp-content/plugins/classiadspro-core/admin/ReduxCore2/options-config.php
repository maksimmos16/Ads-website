	 ...
	 Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'dimensions',
				'units' => array('px'),
				'title' => __('Logo Dimensions', 'classiadspro'),
				'desc' => __('Set logo width and height', 'classiadspro'),
				'default' => array(
					'idth' => '144', 
					'height' => '50'
				),
	 ...
	 Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'title'          => __('Header Listing Button Padding', 'DIRECTORYPRESS'),
				'desc' => __('you can set padding for each corner separately e.g (top =  top left, right = top right, bottom =  bottom right, left = bottom left )', 'DIRECTORYPRESS'),
				'default'            => array(
					'margin-top'     => '', 
					'margin-right'   => '', 
					'margin-bottom'  => '', 
			...
			array(
				...
				'units'          => array('px'),
				'units_extended' => 'false',
				'title'          => __('Header Listing Button Border Radius', 'DIRECTORYPRESS'),
	 ...
	 Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(
				...
				'type' => 'switch',
				'title' => esc_html__('header in grid Postion Absolute', 'classiadspro'),
				"default" => false,
