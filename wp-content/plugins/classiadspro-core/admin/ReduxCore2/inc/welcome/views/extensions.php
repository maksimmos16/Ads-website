...
<div class="wrap about-wrap">
    ...
    <div class="about-text">
        <?php printf( __( 'Supercharge your Redux experience. Our extensions provide you with features that will take your products to the next package.', 'redux-framework' ), esc_html($this->display_version) ); ?>
    </div>
