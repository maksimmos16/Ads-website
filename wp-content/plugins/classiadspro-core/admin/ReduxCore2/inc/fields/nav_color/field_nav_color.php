    ...
    class ReduxFramework_nav_color extends ReduxFramework {
        ...
        public function render() {
            ...
            if ( $this->field['regular'] === true && $this->field['default']['regular'] !== false ):
                echo '<span class="linkColor"><strong>' . esc_html__( 'Regular', 'classiadspro' ) . '</strong><input id="' . $this->field['id'] . '-regular" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][regular]" value="'.$this->value['regular'].'" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['regular'] . '" /></span><br>';
            endif;

            if ( $this->field['hover'] === true && $this->field['default']['hover'] !== false ):
                echo '<span class="linkColor"><strong>' . esc_html__( 'Hover', 'classiadspro' ) . '</strong><input id="' . $this->field['id'] . '-hover" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][hover]" value="' . $this->value['hover'] . '" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['hover'] . '" /></span><br>';
            endif;

            if ( $this->field['bg'] === true && $this->field['default']['bg'] !== false ):
                echo '<span class="linkColor"><strong>' . esc_html__( 'Background Color', 'classiadspro' ) . '</strong><input id="' . $this->field['id'] . '-bg" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][bg]" value="' . $this->value['bg'] . '" class="redux-color redux-color-init ' . $this->field['class'] . '"  type="text" data-default-color="' . $this->field['default']['bg'] . '" /></span><br>';
            endif;            
