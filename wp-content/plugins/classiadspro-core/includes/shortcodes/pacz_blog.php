...
$isotope_el_class = ($style != 'scroller' && $style != 'magazine' && $style != 'slideshow' && $style != 'tile_elegant' && !is_archive() && !is_home() && !is_single()) ? 'isotop-enabled pacz-theme-loop ' : '';
