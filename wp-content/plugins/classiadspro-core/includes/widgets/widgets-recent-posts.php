...
?>
		...
		<p><input type="checkbox" class="checkbox" id="<?php echo esc_attr($this->get_field_id( 'disable_desc' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'disable_desc' )); ?>"<?php checked( $disable_desc ); ?> />
		<label for="<?php echo esc_attr($this->get_field_id( 'disable_desc' )); ?>">Show Description</label></p>
