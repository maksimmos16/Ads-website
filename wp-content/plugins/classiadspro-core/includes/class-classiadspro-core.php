...
class Classiadspro_Core {
	...
	public function classiadspro_register_elementor_widgets() {
		...
		// Register Widgets
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Pacz_Elementor_Blog_Widget() );	
	...
	public function run() {
		...
		$this->loader->add_action('elementor/widgets/widgets_registered', $this, 'classiadspro_register_elementor_widgets');
