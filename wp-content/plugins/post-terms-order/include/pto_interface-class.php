        ...
        function __construct() 
            {
                ...
                if(isset($_REQUEST['_post_type']))
                    {
                        $this->current_post_type    =   filter_var ( $_REQUEST['_post_type'], FILTER_SANITIZE_STRING );
                        if($this->current_post_type    ==  '')
                            $this->current_post_type    =   FALSE;
                    }
                if(isset($_REQUEST['_post_type_object']))
                    {
                        $this->current_post_type_object    =   filter_var ( $_REQUEST['_post_type_object'], FILTER_SANITIZE_STRING );
                        if($this->current_post_type_object  ==  '')
                            $this->current_post_type_object =   FALSE;
                    }
                if(isset($_REQUEST['_taxonomy']))
                    {
                        $this->current_taxonomy    =   filter_var ( $_REQUEST['_taxonomy'], FILTER_SANITIZE_STRING );
        ...
        function general_interface_update()
            {
                ...
                if(isset($_REQUEST['order_type']))
                    {
                        $this->order_type                   =   filter_var ( $_REQUEST['order_type'], FILTER_SANITIZE_STRING );
                        $object_custom_sort['order_type']   =   filter_var ( $_REQUEST['order_type'], FILTER_SANITIZE_STRING );
                    }
        ...
        function automatic_sort_order_update()
            {
                ...
                $this->object_sort_settings['auto_order_by']    =   filter_var ( $_POST['auto_order_by'], FILTER_SANITIZE_STRING );
                $this->object_sort_settings['auto_order']       =   filter_var ( $_POST['auto_order'], FILTER_SANITIZE_STRING );
