<div class="directorypress-modal-content wp-clearfix">
	...
	<div class="field-holder">
		<div><label><?php _e('How to display in search form', 'directorypress-advanced-fields'); ?><span class="directorypress-red-asterisk">*</span></label></div>
		<div>
	...
	<div class="field-holder">
		...
		<div>
			<p><?php _e('OR - filter for any option available', 'directorypress-advanced-fields')?></p>
			<label class="switch">
				<input name="checkboxes_operator" type="radio" value="OR" <?php checked($search_field->checkboxes_operator, 'OR'); ?> />
				<span class="slider"></span>
			</label>
			<p><?php _e('And - filter for exact option available', 'directorypress-advanced-fields')?></p>
			<label class="switch">
