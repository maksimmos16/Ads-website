...
?>
<div class="search-element-col field-id-<?php echo $search_field->field->id; ?> field-form-id-<?php echo $search_form_id; ?> unique-form-field-id-<?php echo $search_field->field->id; ?>_<?php echo $unique_id; ?> field-type-<?php echo $search_field->field->type; ?> pull-left" style=" width:<?php echo $field_width; ?>%; padding:0 <?php echo $gap_in_fields; ?>px;">
	...
	<div class="col-md-12 form-group">
		<input type="text" class="form-control" name="field_<?php echo $search_field->field->slug; ?>" value="<?php echo esc_attr($search_field->value); ?>" />
	</div>
</div>