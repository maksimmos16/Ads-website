...
class Classiads_Templates {
	...
	protected function content() {
		...
		foreach ($all_demo as $index => $demo) {
			if ( $demo['page_builder'] == 'wpbackery' ) {
				$demos[] = $demo;
			}
		}
				...
				<div class="filters-wrap">
					<div class="filter-page-builder filters-page-builder-wrap">
						<ul class="filter-links merlin__other-page-builder">
							<li>
								<a href="#" data-group="wpbackery" class="btn btn-primary merlin__page-builder active js-select-filter">
									<?php echo esc_html('WpBackery'); ?>
								</a>
								<a href="#" data-group="elementor" class="btn btn-primary merlin__page-builder js-select-filter">
	...
	public function designinvento_templates_after_content_import_setup( $selected_import_index ) {
		...
		if($selected_import_index == 17 || $selected_import_index == 26){
			include DT_PATH .'demos/classiads-moto/terms.php';
		}elseif($selected_import_index == 19 || $selected_import_index == 28){
			include DT_PATH .'demos/classiads-phone/terms.php';
		}elseif($selected_import_index == 37){
			include DT_PATH .'demos/elementor/classiads-pets/terms.php';
		}elseif($selected_import_index == 38){
	...
	public function designinvento_template_filter_demo()
	{
		...
		$page_builder = (isset($_POST['page_builder'])) ? $_POST['page_builder'] : 'wpbackery';
		//$category = 'all';
		$all_demo = $this->import_files;
		$html = '';
		$demos = array();
