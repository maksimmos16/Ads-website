<?php
	...
	function directorypress_dashboard_panel_html(){
		...
		<div id="directorypress-panel-sidebar-wrapper" class="jquery-accordion-menu">
			...
			<ul class="clearfix">
				<li class="">
					<a class="parent-menu-link" href="#"><i class="fab fa-adversal"></i><?php _e('Listings', 'directorypress-frontend'); ?></a>
					<ul class="submenu">
				...
				<li id="account" class="">
					<a class="parent-menu-link" href="#"><i class="fas fa-money-bill-alt"></i><span><?php _e('Accounts', 'directorypress-frontend'); ?></span></a>
					<ul class="submenu">
				...
				<?php if($is_messages_addon && ($DIRECTORYPRESS_ADIMN_SETTINGS['message_system'] == 'instant_messages' || $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_listing_bidding'])): ?>
					<li class="">
						<a class="parent-menu-link" href="#"><i class="fa fa-envelope"></i> <span><?php echo esc_html__('Messages', 'directorypress-frontend'); ?> <span class="badge"><?php echo difp_get_user_message_count( 'unread' ); ?></span></span></a>
						<ul class="submenu">
				...
				<?php if ($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_favourites_list']): ?>
					<li class=""><a class="" href="<?php echo directorypress_directorytype_url(array('directorypress_action' => 'myfavourites')); ?>" target="_blank"> <i class="fa fa-heart"></i>  <span><?php echo  __('Bookmarks', 'directorypress-frontend'); ?></span></a></li>
				<?php endif; ?>
				<?php do_action('directorypress_frontend_panel_menu'); ?>
				<?php if(current_user_can('administrator')): ?>
					<li class=""><a href="<?php echo admin_url('/'); ?>" rel="nofollow"><i class="fab fa-wordpress"></i><span><?php echo __('WP Admin', 'directorypress-frontend'); ?></span></a></li>
				<?php endif; ?>
			</ul>
		</div>
<?php }