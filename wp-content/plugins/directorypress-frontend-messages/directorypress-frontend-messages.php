 ...
 * Plugin URI:        https://directorypress.co/product/directorypress-frontend-messages-addon/
...
define( 'DIRECTORYPRESS_FRONTEND_MESSAGES_VERSION', '5.4.0' );
global $wpdb;
			
define('DIFP_PLUGIN_VERSION', '5.3.4' );
