...
class directorypress_search_form {
	...
	public function get_search_form_dynamic_css() {
		if ($this->args['search_custom_style']) {
			...
			$search_form_id = "#directorypress-search-form-" . $this->search_form_id;
			$directorypress_styles .='
				...
				'.$search_form_id.'.directorypress-search-form,
	...
	public function display_search_button($on_row_search_button = false) {
		...
		echo '<div class="directorypress-search-form-button ' . $classes . '">';
			if ($this->args['search_button_type'] == 1 && !empty($icon)) {
				echo '<button type="submit" name="submit" class="btn btn-primary icon-left' . $hide_button_class . '">' . $icon . __('Search', 'DIRECTORYPRESS') . '</button>';
			} elseif ($this->args['search_button_type'] == 2  && !empty($icon)) {
				echo '<button type="submit" name="submit" class="btn btn-primary icon-right' . $hide_button_class . '">' . __('Search', 'DIRECTORYPRESS'). $icon . '</button>';
			}elseif ($this->args['search_button_type'] == 3) {
				echo '<button type="submit" name="submit" class="btn btn-primary' . $hide_button_class . '">' . __('Search', 'DIRECTORYPRESS') . '</button>';
			}elseif ($this->args['search_button_type'] == 4  && !empty($icon)) {
				echo '<button type="submit" name="submit" class="btn btn-primary' . $hide_button_class . '">' . $icon . '</button>';
			}else{
				echo '<button type="submit" name="submit" class="btn btn-primary' . $hide_button_class . '">' . __('Search', 'DIRECTORYPRESS') . '</button>';
			}
		echo '</div>';
	...
	public function display() {
		...
		$this->search_form_id = directorypress_create_random_value();
		...
		directorypress_display_template('partials/search/form.php',
			array(
