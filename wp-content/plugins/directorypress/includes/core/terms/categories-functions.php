			...
			<form class="directorypress-terms-configuration-form" method="POST" action="">
				...
				<div class="tab-pane fade" id="map-icon">
					...
					<div class="form-field term-ct_cat_icon-wrap directorypress-term-form-field">
						...
						<div><input type="text" name="directorypress_category_font_icon" placeholder="<?php _e( 'Insert Icon Class', 'DIRECTORYPRESS' ); ?>" value="<?php echo $directorypress_category_font_icon; ?>" /></div>
					</div>
				</div>
				...
				<div class="tab-pane fade" id="term-color">
					<div class="form-field term-colorpicker-wrap directorypress-term-form-field">
						...
						<div><input name="marker_color" value="<?php echo $directorypress_category_color; ?>" class="colorpicker" id="term-colorpicker" /></div>
					</div>
				</div>
				<div class="id">
...
function directorypress_category_edit_fields($term, $taxonomy ) {
	...
	<tr class="form-field term-ct_cat_icon-wrap directorypress-term-form-field">
        ...
        <td><input type="text" name="directorypress_category_font_icon" placeholder="<?php _e( 'Insert Icon Class', 'DIRECTORYPRESS' ); ?>" value="<?php echo $directorypress_category_font_icon; ?>" /></td>
    </tr>
	<tr class="form-field term-colorpicker-wrap">
        <th scope="row"><label for="term-colorpicker"><?php _e( 'Category Color to use with font icons', 'DIRECTORYPRESS' ); ?></label></th>
        <td>
            <input name="marker_color" value="<?php echo $directorypress_category_color; ?>" class="colorpicker" id="term-colorpicker" />
        </td>
    </tr>
<?php } ?>
		...
		$output .= '<div class="modal-dialog modal-dialog-centered">';
			...
			$output .= '<div class="modal-content">';
				...
				$output .= '<div class="modal-footer">';
					$output .= '<button type="button" class="btn btn-primary update-btn">'. esc_html__('Update', 'DIRETORYPRESS') .'</button>';
					$output .= '<button type="button" class="btn btn-default cancel-btn" data-dismiss="modal">'. esc_html__('Close', 'DIRETORYPRESS') .'</button>';
				$output .= '</div>';
			$output .= '</div>';
		$output .= '</div>';
	$output .= '</div>';
...
function directorypress_render_cat_icon( $cat_icon = array(), $id = 'directorypress_category_icon', $name = '' ) {
        ...
        ob_start();
        ?>
        <div class="directorypress-upload-img" data-field="<?php echo $name; ?>">
            <div class="directorypress-upload-display thumbnail"><div class="centered"><img src="<?php echo $img_src; ?>" /></div></div>
...
function directorypress_save_category_fields_ajax() {
	...
	if ( isset( $_POST['directorypress_category_icon'] ) ) {
            $directorypress_category_icon = $_POST['directorypress_category_icon'];
			 update_term_meta( $term_id, 'directorypress_category_icon', $directorypress_category_icon );
	}
	if ( isset( $_POST['directorypress_category_icon_for_listing'] ) ) {
            $directorypress_category_icon_for_listing = $_POST['directorypress_category_icon_for_listing'];
			 update_term_meta( $term_id, 'directorypress_category_icon_for_listing', $directorypress_category_icon_for_listing );
	}
	if ( isset( $_POST['directorypress_category_icon_for_map'] ) ) {
            $directorypress_category_icon_for_map = $_POST['directorypress_category_icon_for_map'];
			 update_term_meta( $term_id, 'directorypress_category_icon_for_map', $directorypress_category_icon_for_map );
	}
	if ( isset( $_POST['category-image-id'] ) ) {
            $directorypress_category_background_image = $_POST['category-image-id'];
			 update_term_meta( $term_id, 'category-image-id', $directorypress_category_background_image );
	}
	if ( isset( $_POST['directorypress_category_font_icon'] ) ) {
            $directorypress_category_font_icon = $_POST['directorypress_category_font_icon'];
			 update_term_meta( $term_id, 'directorypress_category_font_icon', $directorypress_category_font_icon );
	}
	if ( isset( $_POST['marker_color'] ) ) {
            $directorypress_category_color = $_POST['marker_color'];
			 update_term_meta( $term_id, 'marker_color', $directorypress_category_color );
	}
	
	$response['type'] = 'success';
	$response['message'] = esc_html__('updated successfully', 'DIRETORYPRESS');
...
function get_listing_category_font_marker_icon($term_id){
	...
	if(!empty($icon)){
		...
		$font_icon = 'fas fa-map-marker-alt';
	}
	return $font_icon;
}
