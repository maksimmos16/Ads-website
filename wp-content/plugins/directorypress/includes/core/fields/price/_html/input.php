...
<div class="field-wrap field-input-item field-id-<?php echo $field->id; ?> field-type-<?php echo $field->type; ?> clearfix">
	...
	<div class="row">
		...
		<?php endif; ?>
		<div class="col-md-3 col-sm-6 col-xs-12">
			<input type="text" name="directorypress-field-input-<?php echo $field->id; ?>" class="directorypress-field-input-price form-control" placeholder="<?php echo _e('Insert Price', 'DIRECTORYPRESS'); ?>" value="<?php echo esc_attr($field->data['value']); ?>" size="4" />
		</div>
		<?php if($field->has_input_options): ?>
			<div class="col-md-3 col-sm-6 col-xs-12">
				<select name="directorypress-field-price-options-<?php echo $field->id; ?>" class="directorypress-field-input-select form-control <?php echo esc_attr($select2_class); ?>">
