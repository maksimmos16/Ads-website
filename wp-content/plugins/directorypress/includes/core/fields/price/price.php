...
class directorypress_field_price extends directorypress_field {
	...
	public function display_outputTooltip($listing = null) {
		...
		//if (isset($this->fields[$field_id])) {
			echo '<span class="price-range simptip simptip-position-top simptip-movable" data-tooltip="'.$this->formatPriceRange().'" data-placement="auto">'.$this->range_options_out().'</span>';
		//}
	}
	...
	public function formatPrice($value = null) {
		...
		$currency_symbol = '<span class="currency-symbol">'.$symbol.'</span>';
