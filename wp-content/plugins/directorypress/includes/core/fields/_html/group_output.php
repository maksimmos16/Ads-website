<div class="directorypress-fields-group group-style-<?php echo $fields_group->group_style; ?>">
	<?php if (!$fields_group->on_tab): ?>
	<div class="directorypress-fields-group-caption"><?php echo $fields_group->name; ?></div>
	<?php endif; ?>
