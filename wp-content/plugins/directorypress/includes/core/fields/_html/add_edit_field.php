...
<div class="directorypress-modal-content wp-clearfix">
	<ul class="nav nav-tabs" id="tabContent">
		<li class="active"><a href="#general-<?php echo $itab_id ?>" data-toggle="tab"><?php _e('General', 'DIRECTORYPRESS'); ?></a></li>
		<li><a href="#display-<?php echo $itab_id ?>" data-toggle="tab"><?php _e('Display', 'DIRECTORYPRESS'); ?></a></li>
		<li><a href="#labels-<?php echo $itab_id ?>" data-toggle="tab"><?php _e('Labels', 'DIRECTORYPRESS'); ?></a></li>
		<li><a href="#visibility-<?php echo $itab_id ?>" data-toggle="tab"><?php _e('Visibility', 'DIRECTORYPRESS'); ?></a></li>
		<?php if ($field->is_categories()): ?>
			<li><a href="#dependency-<?php echo $itab_id ?>" data-toggle="tab"><?php _e('Dependency', 'DIRECTORYPRESS'); ?></a></li>
		<?php endif; ?>
	</ul>
	<div class="tab-content">
		<form class="add-edit" method="POST" action="">
			...
			<div class="tab-pane fade active in" id="general-<?php echo $itab_id ?>">
				...
				<?php if ($field->is_slug() && $field->slug != 'price') :?>
					<div class="field-holder">
				...
				<div class="field-holder">
					...
					<select name="type" id="type" <?php disabled($field->is_core_field); ?>>
						...
						<?php if ($field->is_core_field) :?>
							<option value="summary" <?php selected($field->type, 'summary'); ?> ><?php echo $fields_types_names['summary']; ?></option>
							<option value="content" <?php selected($field->type, 'content'); ?> ><?php echo $fields_types_names['content']; ?></option>
							<option value="categories" <?php selected($field->type, 'categories'); ?> ><?php echo $fields_types_names['categories']; ?></option>
							<option value="tags" <?php selected($field->type, 'tags'); ?> ><?php echo $fields_types_names['tags']; ?></option>
							<option value="address" <?php selected($field->type, 'address'); ?> ><?php echo $fields_types_names['address']; ?></option>
							<option value="status" <?php selected($field->type, 'status'); ?> ><?php echo $fields_types_names['status']; ?></option>
						<?php endif; ?>
						<option value="text" <?php selected($field->type, 'text'); ?> ><?php echo $fields_types_names['text']; ?></option>
						<option value="textarea" <?php selected($field->type, 'textarea'); ?> ><?php echo $fields_types_names['textarea']; ?></option>
						<option value="select" <?php selected($field->type, 'select'); ?> ><?php echo $fields_types_names['select']; ?></option>
						<option value="link" <?php selected($field->type, 'link'); ?> ><?php echo $fields_types_names['link']; ?></option>
						<option value="email" <?php selected($field->type, 'email'); ?> ><?php echo $fields_types_names['email']; ?></option>
						<option value="price" <?php selected($field->type, 'price'); ?> ><?php echo $fields_types_names['price']; ?></option>
			...
			<div class="tab-pane fade" id="display-<?php echo $itab_id ?>">
				<div class="field-holder">
			...
			<div class="tab-pane fade" id="labels-<?php echo $itab_id ?>">
				<div class="field-holder">
					<div><?php _e('Label on Grid view', 'DIRECTORYPRESS'); ?></div>
					<select name="is_hide_name_on_grid" id="is_hide_name_on_grid">
						<option value=""><?php _e('Select Option', 'DIRECTORYPRESS'); ?></option>
			...
			<div class="tab-pane fade" id="visibility-<?php echo $itab_id ?>">
