	...
	<div class="row clearfix">
		<div class="<?php echo $classes; ?>">
			<div class="input-group">
				...
				<input type="text" name="directorypress-field-input-url_<?php echo $field->id; ?>" class="form-control" placeholder="<?php _e('URL:', 'DIRECTORYPRESS'); ?>" value="<?php echo esc_url($field->value['url']); ?>" />
			</div>
		</div>
		<?php if ($field->use_link_text): ?>
			<div class="<?php echo $classes; ?>">
				<div class="input-group">
					...
					<input type="text" name="directorypress-field-input-text_<?php echo $field->id; ?>" class="form-control" placeholder="<?php _e('Link Text:', 'DIRECTORYPRESS'); ?>" value="<?php echo esc_attr($field->value['text']); ?>" />
				</div>
			</div>
		<?php endif; ?>
	</div>
