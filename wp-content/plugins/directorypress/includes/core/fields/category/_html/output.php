...
<div class="directorypress-field-item directorypress-field-type-<?php echo $field->type; ?>">
	...
	<span class="field-content">
		...
		?>
			<span class="directorypress-label directorypress-label-primary"><a style="background-color:<?php echo $icon_color; ?>;" href="<?php echo get_term_link($term, DIRECTORYPRESS_CATEGORIES_TAX); ?>" rel="tag"><?php echo $term->name; ?></a>&nbsp;&nbsp;<span class="glyphicon glyphicon-tag"></span></span>
		<?php endforeach; ?>
	</span>
</div>
<?php endif; ?>