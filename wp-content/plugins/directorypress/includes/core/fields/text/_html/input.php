<div class="field-wrap field-input-item field-id-<?php echo $field->id; ?> field-type-<?php echo $field->type; ?> clearfix">
	...
	<input type="text" name="directorypress-field-input-<?php echo $field->id; ?>" class="directorypress-field-input-string form-control" value="<?php echo esc_attr($field->value); ?>" />
</div>