...
class directorypress_bids_widget extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		if (!$instance['visibility'] || !empty($directorypress_object->public_handlers)) {
			...
			//if ($listing_id)
				directorypress_display_template('directorypress-widgets/bids_widget.php', array('args' => $args, 'title' => $title,));
		}
	}
	...
	public function form($instance) {
		...
		directorypress_display_template('directorypress-widgets/bids_widget_options.php', array('widget' => $this, 'instance' => $instance));
	}
...
class directorypress_map_widget extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		if (!$instance['visibility'] || !empty($directorypress_object->public_handlers)) {
			...
			//if ($listing_id)
				directorypress_display_template('directorypress-widgets/map_widget.php', array('height' => 220, 'args' => $args, 'title' => $title,));
		}
	}
	...
	public function form($instance) {
		...
		directorypress_display_template('directorypress-widgets/map_widget_options.php', array('widget' => $this, 'instance' => $instance));
	}
...
class directorypress_resurva_widget extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		if (!$instance['visibility'] || !empty($directorypress_object->public_handlers)) {
			...
			//if ($listing_id)
				directorypress_display_template('directorypress-widgets/resurva_widget.php', array('args' => $args, 'title' => $title,));
		}
	}
	...
	public function form($instance) {
		...
		directorypress_display_template('directorypress-widgets/resurva_widget_options.php', array('widget' => $this, 'instance' => $instance));
	}
...
class directorypress_social_widget extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		if (!$instance['visibility'] || !empty($directorypress_object->public_handlers)) {
			...
			directorypress_display_template('directorypress-widgets/social_widget.php', array('args' => $args, 'title' => $title, 'instance' => $instance));
		}
	}
	...
	public function form($instance) {
		...
		directorypress_display_template('directorypress-widgets/social_widget_options.php', array('widget' => $this, 'instance' => $instance));
	}
