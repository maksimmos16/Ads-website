...
$directorypress_categories_widget_params = array(
		...
		array(
				...
				'param_name' => 'depth',
				'value' => array('1', '2'),
				'heading' => __('Categories nesting package', 'DIRECTORYPRESS'),
		...
		/*array(
				...
				'param_name' => 'grid',
				'value' => array(__('No', 'DIRECTORYPRESS') => '0', __('Yes', 'DIRECTORYPRESS') => '1'),
				'heading' => __('Enable grid view', 'DIRECTORYPRESS'),
		),*/
		/*array(
				'type' => 'dropdown',
				'param_name' => 'grid_view',
				'value' => array(
						__('Standard', 'DIRECTORYPRESS') => '0',
						__('Left Side Grid', 'DIRECTORYPRESS') => '1',
						__('Right Side Grid', 'DIRECTORYPRESS') => '2',
						__('Center Grid', 'DIRECTORYPRESS') => '3',
				),
				'heading' => __('Grid view', 'DIRECTORYPRESS'),
		),*/
		array(
				'type' => 'dropdown',
				'param_name' => 'icons',
