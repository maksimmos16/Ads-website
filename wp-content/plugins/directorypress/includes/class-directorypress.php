...
class DirectoryPress {
	...
	public function __construct() {
		...
		define("DIRECTORYPRESS_OPTIONS_BUILD", $this->plugin_name . '_options_build');
	...
	private function load_dependencies() {
		...
		//require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/license/settings.php';
	...
	public function run() {
		...
		if (isset($_REQUEST['directorypress_action'])) {
			$this->action = $_REQUEST['directorypress_action'];
		}
	...
	/* public function elementorClasses_Init() {
	...
	public function register_widgets() {
		...
		//require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/directorypress-dashboard.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/directorypress-search.php';
		//require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/directorypress-detail.php';
		//require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/elementor/directorypress-map.php';
		// Register Widgets
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Listing_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Category_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Location_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Main_Widget() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Search_Widget() );
		//\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Detail_Widget() );
		//\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Dashboard_Widget() );
		//\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new DirectoryPress_Elementor_Map_Widget() );
	}
