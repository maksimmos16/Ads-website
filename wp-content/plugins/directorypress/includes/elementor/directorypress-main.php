...
class DirectoryPress_Elementor_Main_Widget extends \Elementor\Widget_Base {
	...
	public function __construct($data = [], $args = null) {
      parent::__construct($data, $args);
		...
		//global $post;
		//if ( !metadata_exists( 'post', $post->ID, 'directorypress_elementor_archive_page' ) ) {
		//	add_post_meta( $post->ID, 'directorypress_elementor_archive_page', 1 );
		//}
	...
	protected function render() {
		...
		$directorypress_handler = new directorypress_directory_handler();
