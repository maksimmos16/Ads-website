 ...
 * @subpackage DirectoryPress/admin/partials
 */
					...
					<div class="col-md-4 col-sm-6 col-xs-12">
						<div class="panel-Service-box green">
							...
							<div class="panel-service-content">
								...
								<a href="https://directorypress.co/docs/directorypress/" target="_blank"><?php echo esc_html__('knowledge base', 'DIRECTORYPRESS'); ?></a>
							</div>
						</div>
					</div>
					<div class="col-md-4 col-sm-6 col-xs-12">
