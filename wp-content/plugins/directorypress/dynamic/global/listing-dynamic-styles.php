...
/* padding */
$search_box_padding_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-top'])) ? ('padding-top:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-top'].';') : '';
$search_box_padding_bottom = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-bottom'])) ? ('padding-bottom:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-bottom'].';') : '';
$search_box_padding_left = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-left'])) ? ('padding-left:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-left'].';') : '';
$search_box_padding_right = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-right'])) ? ('padding-right:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_padding']['padding-right'].';') : '';

/* border radius */
$search_box_border_radius_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-top'])) ? ('border-top-left-radius:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-top'].';') : '';
$search_box_border_radius_bottom = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-bottom'])) ? ('border-bottom-right-radius:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-bottom'].';') : '';
$search_box_border_radius_left = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-left'])) ? ('border-bottom-left-radius:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-left'].';') : '';
$search_box_border_radius_right = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-right'])) ? ('border-top-right-radius:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_box_border_radius']['padding-right'].';') : '';


$input_field_height = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_height'])) ? ('height:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_height'].'px;') : '';
$select_selector_line_height = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_height'])) ? ('line-height:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_height'].'px;') : '';
$input_field_height_min = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_height'])) ? ('min-height:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_height'].'px;') : '';
...
$input_field_placeholder_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_box_input_placeholer_color'])) ? ('color:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_box_input_placeholer_color'].';') : '';
$input_field_text_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_box_input_text_color'])) ? ('color:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_box_input_text_color'].';') : '';
$input_field_label_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_box_input_label_color'])) ? ('color:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_box_input_label_color'].';') : '';

$input_field_border_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_border_width'])) ? ('border-width:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_border_width'].'px;') : '';
$input_field_border_radius = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_radius'])) ? ('border-radius:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_field_radius'].'px;') : '';
...
$search_button_family = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-family']) && !empty($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-family'])) ? ('font-family:' . $DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-family'] . ';') : '';
$search_button_font_size = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-size']) && !empty($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-size'])) ? ('font-size:' . $DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-size'] . ';') : '';
$search_button_font_weight = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-weight']) && !empty($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-weight'])) ? ('font-weight:' . $DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['font-weight'] . ';') : '';
$search_button_font_line_height = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['line-height']) && !empty($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['line-height'])) ? ('line-height:' . $DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_text']['line-height'] . ';') : '';
$search_button_font_transform = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_button_text_transform']) && !empty($DIRECTORYPRESS_ADIMN_SETTINGS['search_button_text_transform'])) ? ('text-transform: ' . $DIRECTORYPRESS_ADIMN_SETTINGS['search_button_text_transform'] . ';') : '';

/* border radius */

$search_button_border_radius = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_border_radius'])) ? ('border-radius:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_border_radius'].'px;') : '';

/* background */

//$main_searchbar_bg_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_box_background']['rgba']) && !empty($DIRECTORYPRESS_ADIMN_SETTINGS['search_box_background']['color'])) ? ('background:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_box_background']['rgba'].' !important;') : '';
...
$search_button_border_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_border_width'])) ? ('border-width:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_border_width'].'px;') : '';

/* text color*/

$search_button_text_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_btn_color']['regular'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_btn_color']['regular']. ';') : '';
$search_button_text_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_btn_color']['hover'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['search_form_btn_color']['hover']. ';') : '';
$search_button_icon = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_icon'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['search_form_button_icon'] : '';
...
$search_radius_slider_border_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_border_width'])) ? ('border-width:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_border_width']. 'px;') : '';
$search_radius_slider_height = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_height'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_height'] : '10';
...
$search_radius_slider_range_height = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_range_height'])) ? ('height:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_range_height'].'px;') : '';
$search_radius_slider_range_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_range_top'])) ? ('top:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_range_top']. 'px;') : '';
$search_radius_slider_range_left = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_range_top'])) ? ('left:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_range_top']. 'px;') : '';
...
$search_radius_slider_handle_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_top'])) ? ('top:-'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_top'].'px;') : '';
$search_radius_slider_handle_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'])) ? ('width:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'].'px;') : '';
$search_radius_slider_handle_height = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'])) ? ('height:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'].'px;') : '';
$search_radius_slider_handle_border_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_border_width'])) ? ('border-width:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_border_width'].'px;') : '';

$search_radius_slider_barwidth = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'])) ? ('width: calc(100% - '.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'].'px); width: -webkit-calc(100% - '.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'].'px); width: -moz-calc(100% - '.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'].'px);') : '';
if(is_rtl()){
	$search_radius_slider_barmargin = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'])) ? ('margin-right:'.round($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'] / 2).'px;') : '';
}else{
	$search_radius_slider_barmargin = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'])) ? ('margin-left:'.round($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_handle_width'] / 2).'px;') : '';
}
...
$search_radius_slider_tooltip_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_top'])) ? ('top:-'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_top'].'px;') : '';
$search_radius_slider_tooltip_left = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_left'])) ? ('left:-'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_left'].'px;') : '';
$search_radius_slider_tooltip_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_width'])) ? ('width:'.$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_width'].'px;') : '';
...
$search_radius_slider_tooltip_text_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_text_color'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['search_radius_slider_tooltip_text_color']. ';') : '';
$search_selectbox_selector_icon_bg = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_bg'])) ? ('background:' .$DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_bg']. ';') : '';
$search_selectbox_selector_icon_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_color'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_color']. ';') : '';
$search_selectbox_selector_icon_border_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_color'])) ? ('border-color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_color']. ' transparent transparent transparent;') : '';
$search_selectbox_selector_icon_border_color_open = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_color'])) ? ('border-color: transparent transparent ' .$DIRECTORYPRESS_ADIMN_SETTINGS['search_selectbox_selector_icon_color']. ' transparent;') : '';
...
$search_advanced_fiter_button_color_regular = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_advanced_fiter_button_color']['regular']))? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['search_advanced_fiter_button_color']['regular'].';'): '';
$search_advanced_fiter_button_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['search_advanced_fiter_button_color']['hover']))? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['search_advanced_fiter_button_color']['hover'].';'): '';
...
.directorypress-search-form .search-content-filed-label label,
...
$loc_font_transform = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['loccation_typo_transform'])) ? ('text-transform: ' . $DIRECTORYPRESS_ADIMN_SETTINGS['loccation_typo_transform'] . ';') : '';
...
$child_loc_font_transform = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['childlocation_typo_transform'])) ? ('text-transform: ' . $DIRECTORYPRESS_ADIMN_SETTINGS['childlocation_typo_transform'] . ';') : '';

$parent_loc_title_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['regular'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['regular'] .';') : '';
$parent_loc_title_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['hover'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['hover'] .';') : '';

$parent_loc_title_bg = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['bg'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['bg'] : '';
$parent_loc_title_bg_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['bg-hover'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_title_color']['bg-hover'] : '';

$sublocation_title_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['subloc_title_color']['regular'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['subloc_title_color']['regular'] .';') : '';
$sublocation_title_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['subloc_title_color']['hover'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['subloc_title_color']['hover'] .';') : '';
...
$parent_loc_icon_border_radius = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_icon_border_radius'])) ? ('border-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['parent_loc_icon_border_radius'] .'px;') : '';

$loc_border_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_color']['rgba'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_color']['rgba'] : '';
$loc_border_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_color_hover']['rgba'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_color_hover']['rgba'] : '';

$loc_border_radius_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-top'])) ? ('border-top-left-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-top'] .';') : '';
$loc_border_radius_bottom = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-bottom'])) ? ('border-bottom-right-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-bottom'] .';') : '';
$loc_border_radius_left = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-left'])) ? ('border-bottom-left-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-left'] .';') : '';
$loc_border_radius_right = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-right'])) ? ('border-top-right-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['loc_border_radius']['padding-right'] .';') : '';
...
$pp_title_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_title_color']['regular'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_title_color']['regular']. ' !important;') : '';
$pp_title_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_title_color']['hover'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_title_color']['hover']. ' !important;') : '';

$pp_list_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_list_color']['regular'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_list_color']['regular']. ';') : '';
$pp_list_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_list_color']['hover'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_list_color']['hover']. ';') : '';

$pp_price_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_price_color']['regular'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_price_color']['regular']. ' !important;') : '';
$pp_price_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_price_color']['hover'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_price_color']['hover']. '!important;') : '';

$pp_button_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_button_color']['regular'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_button_color']['regular']. ' !important;') : '';
$pp_button_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_button_color']['hover'])) ? ('color:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_button_color']['hover']. ' !important;') : '';
...
$pp_wrapper_shadow = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_wrapper_shadow'])) ? ('box-shadow:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_wrapper_shadow']. ' !important;') : '';

/* border width */

$pp_wrapper_border_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_wrapper_border_width'])) ? ('border-width:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_wrapper_border_width']. 'px;') : '';
$pp_list_border_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_list_border_width'])) ? ('border-width:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_list_border_width']. 'px !important;') : '';
$pp_button_border_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['pp_button_border_width'])) ? ('border-width:' .$DIRECTORYPRESS_ADIMN_SETTINGS['pp_button_border_width']. 'px;') : '';
...
DirectoryPress_Static_Files::addGlobalStyle("
	...
	.directorypress-choose-plan .directorypress-list-group .directorypress-list-group-item.pp-button a.btn.btn-primary{
		{$pp_button_bg}
	...
	.directorypress-choose-plan .directorypress-list-group .directorypress-list-group-item.pp-button a.btn.btn-primary:hover{
		{$pp_button_bg_hover}
...
$listing_title_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_title_color']['regular'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_title_color']['regular'] .' !important;'): '';
$listing_title_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_title_color']['hover'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_title_color']['hover'] .' !important;') : '';
...
$listing_category_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_cat_color']['regular'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['listing_cat_color']['regular'] : '';
$listing_category_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_cat_color']['hover'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['listing_cat_color']['hover'] : '';
...
$listing_meta_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_meta_color']['regular'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['listing_meta_color']['regular'] : '';
$listing_meta_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_meta_color']['hover'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['listing_meta_color']['hover'] : '';
...
$listing_box_shadow_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_wrapper_shadow_hover'])) ? ('box-shadow:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_wrapper_shadow_hover'] .';') : '';
...
$listing_price_color = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_color']['regular'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_color']['regular'] .';') : '';
$listing_price_color_hover = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_color']['hover'])) ? ('color:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_color']['hover'] .';') : '';

$price_tag_border_radius_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-top'])) ? ('border-top-left-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-top'] .';') : '';
$price_tag_border_radius_bottom = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-bottom'])) ? ('border-bottom-right-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-bottom'] .';') : '';
$price_tag_border_radius_left = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-left'])) ? ('border-bottom-left-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-left'] .';') : '';
$price_tag_border_radius_right = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-right'])) ? ('border-top-right-radius:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_radius']['padding-right'] .';') : '';

$price_tag_position_top = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-top'])) ? ('top:'. $DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-top'] .';'): '';
$price_tag_position_bottom = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-bottom'])) ? ('bottom:'. $DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-bottom'] .';'): '';
$price_tag_position_left = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-left'])) ? ('left:'. $DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-left'] .';'): '';
$price_tag_position_right = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-right'])) ? ('right:'. $DIRECTORYPRESS_ADIMN_SETTINGS['price_tag_position']['padding-right'] .';'): '';

$price_tag_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_width'])) ? ('min-width:'. $DIRECTORYPRESS_ADIMN_SETTINGS['listing_price_tag_width'] .'px;') : '';
...
# Archive
###########################################
$archive_content_area_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['archive_content_area_width'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['archive_content_area_width'] : 67;
$archive_side_area_width = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['archive_side_area_width'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['archive_side_area_width'] : 33;
$archive_side_area_padding = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['archive_side_area_padding'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['archive_side_area_padding'] : 15;
$archive_side_area_position = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['archive_side_area_position'])) ? $DIRECTORYPRESS_ADIMN_SETTINGS['archive_side_area_position'] : 'right';
...
DirectoryPress_Static_Files::addGlobalStyle("
	...
	.directorypress-content-wrap .btn-primary.directorypress-grid-view-btn,
	.directorypress-content-wrap .btn-primary.directorypress-list-view-btn{
		background-color:{$directorypress_primary_color} !important;
	...
	.directorypress-categories-widget .directorypress-parent-category a:hover .categories-count,
...
/* single listing*/
$sliderGutter = (isset($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_single_listing_owl_autoplayGutter']))? $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_single_listing_owl_autoplayGutter']: '';
...
DirectoryPress_Static_Files::addGlobalStyle("
	...
	.#resetpassform .resetpass-submit input:hovet{
		background-color: {$directorypress_primary_color};
	}
");
