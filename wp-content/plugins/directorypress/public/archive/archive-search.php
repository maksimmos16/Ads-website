...
function archive_search_page_function($public_handler, $search_args, $shortcode_atts, $map_args){
	...
	if (get_query_var('page')) {
			...
			if(isset($DIRECTORYPRESS_ADIMN_SETTINGS['archive_page_style'])){
				$public_handler->template = 'partials/archive/search-archive-'. $DIRECTORYPRESS_ADIMN_SETTINGS['archive_page_style'] .'.php';
			}else{
				$public_handler->template = 'partials/archive/search-archive-1.php';
			}
