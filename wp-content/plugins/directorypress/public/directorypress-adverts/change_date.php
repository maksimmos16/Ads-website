		...
		<div class="theme-browser rendered">
			<div class="directorypress-box">
				<div class="directorypress-box-head">
					<?php _e('Change expiration date', 'DIRECTORYPRESS'); ?>
				</div>
				<div class="directorypress-box-content wp-clearfix">
					...
					<form action="<?php echo admin_url('options.php?page=directorypress_changedate&listing_id=' . $listing->post->ID . '&changedate_action=changedate&referer=' . urlencode($referer)); ?>" method="POST">
						<p>
