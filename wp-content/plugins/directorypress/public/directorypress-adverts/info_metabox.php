...
<div id="misc-publishing-actions">
	...
	<div class="misc-pub-section">
		...
		<select id="directory_id" name="directory_id">
			...
			<option value="<?php echo $directorytype->id; ?>" <?php selected($directorytype->id, $listing->directorytype->id, true); ?>><?php echo $directorytype->name; ?></option>
			<?php endforeach; ?>
		</select>
	</div>
	<?php endif; ?>
	...
	<div class="misc-pub-section">
		...
		<span id="post-package-display">
			...
			if ($listing->listing_created && $listing->package->is_upgradable())
					echo '<a href="' . admin_url('options.php?page=directorypress_upgrade&listing_id=' . $listing->post->ID) . '">';
			else
				echo '<b>'; ?>
	...
	<div class="misc-pub-section">
		...
		<span id="post-package-display">
			...
			<a href="<?php echo admin_url('options.php?page=directorypress_renew&listing_id=' . $listing->post->ID); ?>"><span class="directorypress-fa directorypress-fa-refresh directorypress-fa-lg"></span> <?php echo apply_filters('directorypress_renew_option', __('renew listing', 'DIRECTORYPRESS'), $listing); ?></a>
	...
	<div class="misc-pub-section curtime">
		<span id="timestamp">
			...
			<br />
			<a href="<?php echo admin_url('options.php?page=directorypress_raise_up&listing_id=' . $listing->post->ID); ?>"><span class="directorypress-fa directorypress-fa-package-up directorypress-fa-lg"></span> <?php echo apply_filters('directorypress_raiseup_option', __('raise up listing', 'DIRECTORYPRESS'), $listing); ?></a>
			<?php endif; ?>
		</span>
	</div>
