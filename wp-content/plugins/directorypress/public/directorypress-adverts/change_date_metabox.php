...
<p><?php _e("Regular users can not change expiration date. This option is available only for admins.", 'DIRECTORYPRESS'); ?></p>
<?php endif; ?>

<p><?php _e("Set new expiration date and time of the listing.<br />Be careful: If you'll set past date - listing will expire in some minutes.", 'DIRECTORYPRESS'); ?></p>

<div class="directorypress-content-wrap directorypress-content-wrap-fields-metabox">
	<div class="directorypress-field directorypress-form-group directorypress-form-horizontal">
		<label class="directorypress-col-md-1 directorypress-control-label">
			<?php _e('Date:', 'DIRECTORYPRESS'); ?>
		</label>
		<div class="directorypress-col-md-3">
			<div class="has-feedback">
				<input type="text" id="expiration_date" class="form-control" />
				<span class="glyphicon glyphicon-calendar directorypress-form-control-feedback"></span>
			</div>
		</div>
		<label class="directorypress-col-md-1 directorypress-control-label"><?php _e('Time:', 'DIRECTORYPRESS'); ?></label>
		<div class="directorypress-col-md-3">
