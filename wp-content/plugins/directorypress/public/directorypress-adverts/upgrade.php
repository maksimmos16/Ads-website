		...
		<div class="theme-browser rendered">
			<div class="directorypress-box">
				...
				<div class="directorypress-box-content wp-clearfix">
					...
					<form action="<?php echo admin_url('options.php?page=directorypress_upgrade&listing_id=' . $listing->post->ID . '&upgrade_action=upgrade&referer=' . urlencode($referer)); ?>" method="POST">
						<?php if ($action == 'show'): ?>
						...
						<p>
							<label><input type="radio" name="new_package_id" value="<?php echo $package->id; ?>" /> <?php echo apply_filters('directorypress_package_upgrade_option', $package->name, $listing->package, $package); ?></label>
						</p>
						<?php endif; ?>
						<?php endforeach; ?>
