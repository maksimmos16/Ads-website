...
<?php if ($action == 'show'): ?>
<a href="<?php echo admin_url('options.php?page=directorypress_raise_up&listing_id=' . $listing->post->ID . '&raiseup_action=raiseup&referer=' . urlencode($referer)); ?>" class="button button-primary"><?php _e('Raise up', 'DIRECTORYPRESS'); ?></a>
&nbsp;&nbsp;&nbsp;
