...
class DirectoryPress_Public_Handler {
	...
	public function __construct( $plugin_name, $version ) {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/archive/archive-index.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/single-listing/single-listing-functions.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/archive/archive-category.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/archive/archive-location.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/archive/archive-tags.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/archive/archive-search.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/archive/archive-bookmark.php';
	...
	public function enqueue_styles() {
		...
		wp_register_style('select2', DIRECTORYPRESS_RESOURCES_URL . 'lib/select2/css/select2.css');
			...
			wp_register_style('jquery-ui', '//ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/themes/smoothness/jquery-ui.min.css');
			...
			if(directorypress_is_archive_page()){
				...
				wp_enqueue_style('directorypress_listing_style_'.$style);
	...
	public function enqueue_scripts() {
			...
			wp_register_script('masonry-js', DIRECTORYPRESS_RESOURCES_URL . 'lib/masonry/js/masonry.pkgd.min.js', array('jquery'), false, true);
			wp_register_script('lightbox-js', DIRECTORYPRESS_RESOURCES_URL . 'lib/lightbox/js/lightbox.min.js', array('jquery'), false, true);
			wp_register_script('jquery-lity-js', DIRECTORYPRESS_RESOURCES_URL . 'lib/lity/js/lity.min.js', array('jquery'), false, true);
			wp_register_script('select2-js', DIRECTORYPRESS_RESOURCES_URL . 'lib/select2/js/select2.min.js', array('jquery'), false, true);
			...
			wp_register_script('slick-carousel-triger-js', DIRECTORYPRESS_RESOURCES_URL . 'lib/slick-carousel/js/slick-triger.min.js', array('jquery'), false, true);
			wp_register_script('directorypress-public-js', DIRECTORYPRESS_RESOURCES_URL . 'js/directorypress-public.js', array('jquery'), false, true);
			wp_register_script('jquery-cookie-js', DIRECTORYPRESS_RESOURCES_URL . 'js/jquery.cookie.js', array('jquery'), false, true);
			wp_register_script('directorypress-terms-js', DIRECTORYPRESS_RESOURCES_URL . 'js/directorypress-terms.js', array('jquery'), false, true);
			wp_register_script('directorypress-contact-js', DIRECTORYPRESS_RESOURCES_URL . 'js/contact-form.js', array('jquery'), false, true);
			wp_register_script('directorypress-compare-js', DIRECTORYPRESS_RESOURCES_URL . 'js/compare.js', array('jquery'), false, true);
			...
			wp_enqueue_script('jquery-lity-js');
			...
			wp_enqueue_script('directorypress-contact-js');
			...
			wp_enqueue_script('directorypress-public-js');
	...
	public function enqueue_global_vars() {
		...
		echo 'var directorypress_js_instance = ' . json_encode(
				array(
						...
						'in_favourites_icon4' => $in_favourites_icon4,
						...
						'not_in_favourites_icon4' => $not_in_favourites_icon4,
						'in_favourites_msg' => __('Remove Bookmark', 'DIRECTORYPRESS'),
						'not_in_favourites_msg' => __('Add Bookmark', 'DIRECTORYPRESS'),
						'ajax_load' => true,
						'is_rtl' => is_rtl(),
	...
	if (directorypress_has_map()){	
		...
		echo 'var directorypress_maps_instance = ' . json_encode(
				array(
						...
						//'marker_image_width' => (int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_marker_width'],
						//'marker_image_height' => (int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_marker_height'],
						//'marker_image_anchor_x' => (int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_marker_anchor_x'],
						//'marker_image_anchor_y' => (int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_marker_anchor_y'],
						//'infowindow_width' => (int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_infowindow_width'],
						//'infowindow_offset' => -(int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_infowindow_offset'],
						//'infowindow_logo_width' => (int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_infowindow_logo_width'],
						//'infowindow_logo_height' => (int)$DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_map_infowindow_logo_height'],
						...
						'draw_area_button' => __('', 'DIRECTORYPRESS'),
						'edit_area_button' => __('', 'DIRECTORYPRESS'),
						'apply_area_button' => __('', 'DIRECTORYPRESS'),
						'reload_map_button' => __('', 'DIRECTORYPRESS'),
