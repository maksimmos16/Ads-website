...
<p>
	...
	<label for="<?php echo $widget->get_field_id('is_facebook'); ?>"><?php _e('Show Facebook Button', 'DIRECTORYPRESS'); ?></label>
</p>
<p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('is_twitter'); ?>"><?php _e('Show Twitter Button', 'DIRECTORYPRESS'); ?></label>
</p>
<p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('is_linkedin'); ?>"><?php _e('Show LinkedIn Button', 'DIRECTORYPRESS'); ?></label>
</p>
<p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('is_youtube'); ?>"><?php _e('Show YouTube Button', 'DIRECTORYPRESS'); ?></label>
</p>
<p>
...
<p>
	...
	<label for="<?php echo $widget->get_field_id('is_rss'); ?>"><?php _e('Show RSS Button', 'DIRECTORYPRESS'); ?></label>
</p>
<p>
