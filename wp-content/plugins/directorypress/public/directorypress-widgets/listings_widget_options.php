...
<p>
	<input id="<?php echo $widget->get_field_id('is_has_sticky_has_featured'); ?>" name="<?php echo $widget->get_field_name('is_has_sticky_has_featured'); ?>" type="checkbox" value="1" <?php checked($instance['is_has_sticky_has_featured'], 1, true); ?> />
	<label for="<?php echo $widget->get_field_id('is_has_sticky_has_featured'); ?>"><?php _e('Sticky and has_featured listings on top'); ?></label> 
</p>
<p>
	<input id="<?php echo $widget->get_field_id('only_has_sticky_has_featured'); ?>" name="<?php echo $widget->get_field_name('only_has_sticky_has_featured'); ?>" type="checkbox" value="1" <?php checked($instance['only_has_sticky_has_featured'], 1, true); ?> />
	<label for="<?php echo $widget->get_field_id('only_has_sticky_has_featured'); ?>"><?php _e('Only has_sticky and has_featured listings'); ?></label> 
</p>
<p>
