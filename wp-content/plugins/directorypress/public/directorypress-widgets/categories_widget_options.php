...
<p>
	...
	<option value=1 <?php selected($instance['style'], 1); ?>><?php echo esc_html__('Style 1 (default)', 'DIRECTORYPRESS'); ?></option>
	<option value=2 <?php selected($instance['style'], 2); ?>><?php echo esc_html__('Style 2 (ultra)', 'DIRECTORYPRESS'); ?></option>
	</select>
</p>
<p>
	<label for="<?php echo $widget->get_field_id('depth'); ?>"><?php _e('Categories nesting package:'); ?></label>
...
<p>
	...
	<p class="description"><?php _e('Leave 0 to show all subcategories', 'DIRECTORYPRESS'); ?></p>
</p>
<p>
	...
	<p class="description"><?php _e('Leave 0 to show all root categories', 'DIRECTORYPRESS'); ?></p>
</p>
<p>
	<label for="<?php echo $widget->get_field_id('cat_icon_type'); ?>"><?php _e('Categories Icon Type:'); ?></label>
	<select id="<?php echo $widget->get_field_id('cat_icon_type'); ?>" name="<?php echo $widget->get_field_name('cat_icon_type'); ?>">
	<option value=1 <?php selected($instance['cat_icon_type'], 1); ?>> Font Icon</option>
	<option value=2 <?php selected($instance['cat_icon_type'], 2); ?>> Image Icon</option>
	<option value=3 <?php selected($instance['cat_icon_type'], 3); ?>> SVG Icon</option>
	</select>
</p>
<p>
