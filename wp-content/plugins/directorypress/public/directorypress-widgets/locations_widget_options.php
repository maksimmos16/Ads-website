...
<p>
	<label for="<?php echo $widget->get_field_id('depth'); ?>"><?php _e('Locations nesting package:'); ?></label>
...
<p>
	<label for="<?php echo $widget->get_field_id('sublocations'); ?>"><?php _e('Show sub-locations items number:'); ?></label> 
	...
	<p class="description"><?php _e('Leave 0 to show all sublocations', 'DIRECTORYPRESS'); ?></p>
</p>
<p>
	...
	<p class="description"><?php _e('Leave 0 to show all root locations', 'DIRECTORYPRESS'); ?></p>
</p>
<p>
