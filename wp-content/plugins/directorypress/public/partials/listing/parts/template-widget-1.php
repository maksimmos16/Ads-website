<?php
	...
	echo '<figure class="directorypress-listing-figure">';
		echo '<a href="'.get_permalink().'"><img alt="'.$listing->title().'" src="'. bfi_thumb($image_src_w, $param).'" width="150" height="150" /><span class="listing-widget-hover-overlay"><i class="directorypress-icon-share"></i></span></a>';
	echo '</figure>';