			...
			window.directorypress_image_attachment_tpl_clogo = function(attachment_id, uploaded_file, title) {
				...
				var image_attachment_tpl_clogo = '<div class="directorypress-attached-item clogo">' +
					...
					'<div class="thumb-links clearfix">' +
						'<div class="directorypress-attached-item-delete clogo fas fa-trash-alt" title="<?php esc_attr_e("remove", "DIRECTORYPRESS"); ?>"></div>' +
					'</div>' +
					'</div>';
		...
		<div id="directorypress-attached-images-wrapper" class="clogo full clearfix">
			...
			?>
				<div class="directorypress-attached-item clogo">
					...
					<img src="<?php echo bfi_thumb($image_src, $param); ?>" width="126" height="100" alt="<?php echo esc_attr_e('Company Logo', 'DIRECTORYPRESS'); ?>" />
					<div class="thumb-links clearfix">
						<div class="directorypress-attached-item-delete clogo fas fa-trash-alt" title="<?php _e("delete", "DIRECTORYPRESS"); ?>"></div>
					</div>
				</div>
			<?php endif; ?>
			<?php if (!is_admin()): ?>
