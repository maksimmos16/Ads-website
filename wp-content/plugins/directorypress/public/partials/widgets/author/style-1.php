<?php 
	...
	*/
	...
	echo '<div class="directorypress-author clearfix">';
		...
		echo '<div class="author-content">';
			...
			if($DIRECTORYPRESS_ADIMN_SETTINGS['author_profile_view']){
				echo '<div class="author-link"><a href="'. home_url('/profile/') . $author_nicename .'" class="">'. esc_html__('view profile', 'DIRECTORYPRESS').'</a></div>';
			}
		echo '</div>';
	echo '</div>';
