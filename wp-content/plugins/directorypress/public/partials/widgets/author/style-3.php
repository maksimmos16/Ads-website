<?php
	...
	*/
	...
	echo '<div class="directorypress-author style3 clearfix">';
		...
		if($hide_from_anonymous && !is_user_logged_in()){
			...
			if(!empty($phone_number) && $show_phone_number){
				echo '<div class="author-phone">';
					echo '<a class="" href="tel:'.$phone_number.'"><i class="fas fa-phone"></i>'. $phone_number .'</a>';
				echo '</div>';
			}
			if(!empty($whatsapp_number) && $show_whatsapp_number){
				echo '<div class="author-phone whatsapp">';
					echo '<a class="" href="https://api.whatsapp.com/send?phone='.$whatsapp_number.'"><i class="fab fa-whatsapp"></i>'. $whatsapp_number .'</a>';
				echo '</div>';
			}
