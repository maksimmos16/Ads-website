...
<script>
	(function($) {
		...
		$(function() {
			var location_number_allowed = <?php echo $listing->package->location_number_allowed; ?>;
			...
			$(".add_address").click(function() {
				...
				$.ajax({
					...
					data: {'action': 'directorypress_add_location_in_metabox', 'post_id': <?php echo $listing->post->ID; ?>},
	...
	<?php if(directorypress_has_map()): ?>
		<div class="directorypress-maps-canvas-wrap">
			<div class="generate-map-btn">
				<input type="hidden" name="map_zoom" class="directorypress-map-zoom" value="<?php echo $listing->map_zoom; ?>" />
