	...
	echo '<div class="listings listing-archive archive-style-nosidebar">';
			...
			if ($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_main_search']){
				...
				if(!empty($public_handler->archive_below_search_banner)){
					echo '<div class="archive-banner">';
						echo $public_handler->archive_below_search_banner;
					echo '</div>';
				}
			...
			directorypress_renderMessages();
			 if ($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_show_categories_index']){
				...
				echo '</div>';
				if(!empty($public_handler->archive_below_category_banner)){
					echo '<div class="archive-banner">';
						echo $public_handler->archive_below_category_banner;
					echo '</div>';
				}
			...
			if ($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_show_locations_index']){
				...
				echo '</div>';
				if(!empty($public_handler->archive_below_locations_banner)){
					echo '<div class="archive-banner">';
						echo $public_handler->archive_below_locations_banner;
					echo '</div>';
				}
			}
			...
			if ($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_listings_on_index']){
				...
				if(!empty($public_handler->archive_below_listings_banner)){
					echo '<div class="archive-banner">';
						echo $public_handler->archive_below_listings_banner;
					echo '</div>';
				}
			}
	echo '</div>';