<?php
	...
	echo '<div id="loaction-styles'.$instance->args['id'].'" class="location-style-'.$instance->location_style.' grid-item directorypress-locations-columns clearfix" style="'.$gutter.'">';
			...
			echo '<div class="directorypress-location-item">';
				...
				echo '<div class="directorypress-location-item-holder">';
					...
					echo '<div class="directorypress-parent-location">';
						echo '<a href="' . get_term_link($term) . '" title="' . $term->name .$term_count . '"><span class="loaction-name">' . $term->name .'</span><span class="location-item-numbers">'.$term_count.'</span></a>';
					echo '</div>';
				echo '</div>';
				if($instance->depth > 1 && $instance->has_child){
					echo '<div class="directorypress-custom-popup" data-popup="' . $term->term_id . '">';
									echo '<div class="directorypress-custom-popup-inner">';
										echo '<div class="sub-category">';
											echo '<div class="categories-title">'.esc_html__('Select your Location', 'DIRECTORYPRESS').'<a class="directorypress-custom-popup-close" data-popup-close="' . $term->term_id . '" href="#"><i class="far fa-times-circle"></i></a></div>';
