...
$head_section_bg = (isset($cover_url) && !empty($cover_url))? ('background-image:url('.$cover_url.');'):'background-color:#8893b9;';
$field_ids = $wpdb->get_results('SELECT id, type, slug, options FROM '.$wpdb->prefix.'directorypress_fields');
?>
<div class="directorypress-listing-directory-head-section" style="<?php echo $head_section_bg; ?> min-height:400px;"></div>
<div class="directorypress-directory-head-section-content-wrapper">
	<div class="directorypress-directory-head-section-content-wrapper-inner clearfix">
		<div class="container clearix">
			<div class="directorypress-single-listing-company-logo"><img src="<?php echo $clogo_url; ?>" alt="" /></div>
