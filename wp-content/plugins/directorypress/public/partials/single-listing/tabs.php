...
<div class="single-listing-tabs-wrapper">
	<script>
		(function($) {
			...
			$(function() {
				<?php if ($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress-listings-tabs-order']['enabled']): 
				...
				<?php foreach ($tab_ordering as $key=>$value): ?>
						...
						directorypress_show_tab($('.directorypress-listing-tabs a[data-tab="#<?php echo $key; ?>"]'));
				<?php endforeach; ?>
				<?php else: ?>
	...
	<?php if (($fields_groups = $listing->get_fields_groups_in_tabs()) || ($listing->is_map() && $listing->locations) || (directorypress_is_reviews_allowed()) || ($listing->package->videos_allowed && $listing->videos) || $DIRECTORYPRESS_ADIMN_SETTINGS['message_system'] == 'email_messages'): ?>
		<?php if(wp_is_mobile()){ ?>
								<ul class="directorypress-listing-tabs nav navbar-nav clearfix" role="tablist">
									<?php if (directorypress_has_map() && ($DIRECTORYPRESS_ADIMN_SETTINGS['map_on_single_listing_tab'] && $listing->is_map() && $listing->locations)): ?>
									...
									<li><a href="javascript: void(0);" data-tab="#comments-tab" role="tab"><i class="directorypress-icon-comments-o"></i><?php echo _n('Comment', 'Comments', $listing->post->comment_count, 'DIRECTORYPRESS'); ?> (<?php echo $listing->post->comment_count; ?>)</a></li>
									<?php endif; ?>
									...
									<li><a href="javascript: void(0);" data-tab="#videos-tab" role="tab"><i class="directorypress-icon-play"></i><?php echo _n('Video', 'Videos', count($listing->videos), 'DIRECTORYPRESS'); ?> (<?php echo count($listing->videos); ?>)</a></li>
									<?php endif; ?>
									<?php
		...
		<?php }else{ ?>
			<ul class="directorypress-listing-tabs nav nav-tabs clearfix" role="tablist">
									<?php if (directorypress_has_map() && ($DIRECTORYPRESS_ADIMN_SETTINGS['map_on_single_listing_tab'] && $listing->is_map() && $listing->locations && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_listings_map_position'] == 'intab')): ?>
									...
									<?php endif; ?>
									<?php if (directorypress_is_reviews_allowed() && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_listings_comments_position'] == 'intab'): ?>
									<li><a href="javascript: void(0);" data-tab="#comments-tab" data-toggle="directorypress-tab" role="tab"><i class="directorypress-icon-comments-o"></i><?php echo _n('Comment', 'Comments', $listing->post->comment_count, 'DIRECTORYPRESS'); ?> (<?php echo $listing->post->comment_count; ?>)</a></li>
									<?php endif; ?>
									<?php if ($listing->package->videos_allowed && $listing->videos && $DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_listings_video_position'] == 'intab'): ?>
									<li><a href="javascript: void(0);" data-tab="#videos-tab" data-toggle="directorypress-tab" role="tab"><i class="directorypress-icon-play"></i><?php echo _n('Video', 'Videos', count($listing->videos), 'DIRECTORYPRESS'); ?> (<?php echo count($listing->videos); ?>)</a></li>
									<?php endif; ?>
									<?php
									foreach ($fields_groups AS $fields_group): ?>
									<li><a href="javascript: void(0);" data-tab="#field-group-tab-<?php echo $fields_group->id; ?>" data-toggle="directorypress-tab" role="tab"><?php echo $fields_group->name; ?></a></li>
									<?php endforeach; ?>
			</ul>
		<?php } ?>
		<div class="tab-content">
								...
								<?php foreach ($fields_groups AS $fields_group): ?>
									<div id="field-group-tab-<?php echo $fields_group->id; ?>" class="tab-pane fade" role="tabpanel">
										<?php echo $fields_group->display_output($listing); ?>
									</div>
								<?php endforeach; ?>
		</div>
	<?php endif; ?>
