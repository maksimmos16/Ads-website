...
if ( ! class_exists( 'DHE_Form_Eval_Math', false ) ) {
	/**
	 * Class DHE_Form_Eval_Math. Supports basic math only (removed eval function).
	 *
	 * Based on EvalMath by Miles Kaufman Copyright (C) 2005 Miles Kaufmann http://www.twmagic.com/.
	 */
	class DHE_Form_Eval_Math {
		...
		private static function nfx( $expr ) {
			...
			$index = 0;
			$stack = new DHE_Form_Eval_Math_Stack;
	...
	/**
	 * Class DHE_Form_Eval_Math_Stack.
	 */
	class DHE_Form_Eval_Math_Stack {
