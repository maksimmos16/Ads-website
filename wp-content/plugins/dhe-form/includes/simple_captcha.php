...
if ( ! class_exists( 'DHE_Form_Simple_Captcha', false ) ) {
	class DHE_Form_Simple_Captcha {
		public $chars;
		public $char_length;
		public $fonts;
		public $tmp_dir;
		...
		public function __construct() {
			...
			$this->fonts = array(
				DHE_FORM_DIR . '/assets/fonts/gentium/GenBkBasR.ttf',
				DHE_FORM_DIR . '/assets/fonts/gentium/GenBkBasI.ttf',
				DHE_FORM_DIR . '/assets/fonts/gentium/GenBkBasBI.ttf',
				DHE_FORM_DIR . '/assets/fonts/gentium/GenBkBasB.ttf',
			);
		
			/* Directory temporary keeping CAPTCHA images and corresponding text files */
			$this->tmp_dir = path_join( DHE_FORM_DIR, 'tmp' );
		...
		public function generate_image( $prefix, $word ) {
			...
			if ( $im = imagecreatetruecolor( $this->img_size[0], $this->img_size[1] ) ) {
				...
				$pixel = imagecolorallocate($im, 0, 0, 50);
				
				for( $i = 0; $i < 200; $i++ ){
					imagesetpixel( $im, rand() % 150, rand() % 45, $pixel);
				}
