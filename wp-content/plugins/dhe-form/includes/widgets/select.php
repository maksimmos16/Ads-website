...
class DHE_Form_Widget_Select extends DHE_Form_Widget_Base {
	...
	public function get_title() {
		return __( 'Select Field', 'dhe-form' );
	}
...
function dhe_form_field_select_validation_filter($result, $field){
	$name = $field->get_name();
	...
	if($field->is_required() && $empty){
		$result->invalidate($field, dhe_form_get_message('invalid_select'));
	}
	return $result;

}
add_filter( 'dhe_form_validate_select', 'dhe_form_field_select_validation_filter', 10, 2 );
