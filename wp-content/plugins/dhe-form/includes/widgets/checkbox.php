...
class DHE_Form_Widget_Checkbox extends DHE_Form_Widget_Base {

	public function get_name() {
		return 'dhe_form_checkbox';
	}

	public function get_title() {
		return __( 'Checkbox Field', 'dhe-form' );
	}

	public function get_icon() {
		return 'dhe-form-icon-widget-checkbox';
	}
...
function dhe_form_field_checkbox_validation_filter($result, $field){
	$name = $field->get_name();
...
add_filter( 'dhe_form_validate_checkbox', 'dhe_form_field_checkbox_validation_filter', 10, 2 );
