...
class DHE_Form_Widget_Textarea extends DHE_Form_Widget_Base {
	
	public function get_name() {
		return 'dhe_form_textarea';
	}
	
	public function get_title() {
		return __( 'Textarea Field', 'dhe-form' );
	}
	
	public function get_icon() {
		return 'dhe-form-icon-widget-textarea';
	}
...
function dhe_form_field_textarea_validation_filter($result, $field){
	$name = $field->get_name();
...
add_filter( 'dhe_form_validate_textarea', 'dhe_form_field_textarea_validation_filter', 10, 2 );
