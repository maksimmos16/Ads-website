...
Accept secure MTN Mobile Money MoMo payments on your WooCommerce web store or eShop.
...
* Fixed issues with multisite installations and payment status updates
