...
do_action('pacz_templates_compatibility_check', '1.4.14');
...
function pacz_classiadspro_register_required_plugins() {
	...
	$dynamic_url = 'https://assets.designinvento.net/plugins/classiadspro/5-10-1/';
    $plugins = array(
        array(
            'name' => 'Classiads Templates',
            'slug' => 'classiads-templates',
            'source' => $dynamic_url.'classiads-templates.zip',
            'required' => true,
            'version' => '1.4.14',
