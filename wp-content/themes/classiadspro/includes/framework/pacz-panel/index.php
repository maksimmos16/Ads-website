				...
				<div class="pacz-col-md-4 pacz-col-sm-6 pacz-col-xs-12">
					<div class="panel-Service-box">
						...
						<div class="panel-service-content">
							...
							<a href="http://help.designinvento.net/" target="_blank"><?php echo esc_html__('knowledge base', 'classiadspro'); ?></a>
						</div>
					</div>
				</div>
				<div class="pacz-col-md-4 pacz-col-sm-6 pacz-col-xs-12">
					<div class="panel-Service-box">
						...
						<div class="panel-service-content">
							...
							<a href="http://help.designinvento.net/" target="_blank"><?php echo esc_html__('Support Desk', 'classiadspro'); ?></a>
						</div>
					</div>
				</div>
				<div class="pacz-col-md-4 pacz-col-sm-6 pacz-col-xs-12">
					<div class="panel-Service-box">
						...
						<div class="panel-service-content">
							...
							<a href="http://help.designinvento.net/" target="_blank"><?php echo esc_html__('Feature Suggestions', 'classiadspro'); ?></a>
						</div>
					</div>
				</div>
		</div>
