<?php
	...
	}elseif ($instance->location_style == 2){
		directorypress_display_template('partials/terms/locations/parts/location-style-2.php', array('instance' => $instance, 'terms' => $terms));
	}elseif ($instance->location_style == 3){
		directorypress_display_template('partials/terms/locations/parts/location-style-3.php', array('instance' => $instance, 'terms' => $terms));
	...
	// custom styling
		...
		$location_width = (isset($instance->location_width) && !empty($instance->location_width))? ('width:' . $instance->location_width . '%;') : '';
		$location_height = (isset($instance->location_height) && !empty($instance->location_height))? ('height:' . $instance->location_height . 'px;') : '';
