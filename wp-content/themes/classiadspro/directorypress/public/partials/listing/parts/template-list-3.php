<?php
	...
	echo '<div class="list-author-content-area">';
		...
		echo '<div class="listng-author-url-link">';
			echo  '<a href="'.home_url('/profile/') . $author_nicename.'">'.esc_html__('see all ads', 'classiadspro').'</a>';
		echo '</div>';
		echo '<div class="listng-author-url">';
			echo  '<a href="'.home_url('/profile/') . $author_nicename.'">'.esc_html__('contacts', 'classiadspro').'</a>';
		echo '</div>';
	echo '</div>';