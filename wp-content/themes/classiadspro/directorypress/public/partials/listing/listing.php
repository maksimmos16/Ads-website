	...
	if(!function_exists('directorypress_listing_grid_featured_tag')){
		function directorypress_listing_grid_featured_tag($listing){
			...
			if($feature_tag_style == 1){
				...
				$feature_tag = '<span class="has_featured-tag-3"><i class="fas fa-star"></i></span>';
			}elseif($feature_tag_style == 4){
				$feature_tag = '<span class="has_featured-tag-4"><i class="fas fa-star"></i></span>';
				...
				$feature_tag = '<span class="has_featured-tag-7"><i class="fas fa-star"></i></span>';
			}elseif($feature_tag_style == 8){
				$feature_tag = '<span class="has_featured-tag-8"><i class="fas fa-star"></i></span>';
			}elseif($feature_tag_style == 9){
				$feature_tag = '<span class="has_featured-tag-9"><i class="fas fa-star"></i></span>';
			...
			if($DIRECTORYPRESS_ADIMN_SETTINGS['directorypress_ratings_addon']){
				if (!empty($rating)){
					...
					echo '<div class="listing-rating grid-rating">';
						...
						echo '&nbsp;<span class="review_rate-empty"><a class="simptip simptip-position-top simptip-movable" href="'. get_permalink() .'#comments-reviews" data-tooltip="'.esc_html__('Be first to rate', 'classiadspro').'">'.esc_html__('Rate Now', 'classiadspro').'</a></span>';
					echo '</div>';
				}
			}
		}
	...
	if(!function_exists('directorypress_listing_grid_bookmark')){
		function directorypress_listing_grid_bookmark($listing, $style){
			...
			if (directorypress_bookmark_list($listing->post->ID)){
				$hear_icon = 'heart';
				if($style == 1){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Remove Bookmarks', 'classiadspro').'"><span class="style1 checked fas fa-heart"></span></a>';
				}elseif($style == 2){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Remove Bookmarks', 'classiadspro').'"><span class="style2 checked fas fa-heart"></span></a>';
				}elseif($style == 3){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Remove Bookmarks', 'classiadspro').'"><span class="style3 checked far fa-bookmark"></span></a>';
				}elseif($style == 4){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Remove Bookmarks', 'classiadspro').'"><span class="style4 checked fas fa-bookmark"></span><span class="bookmark-text">'. esc_html__('bookmarked', 'classiadspro') .'</span></a>';
				}
			}else{
				if($style == 1){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Bookmark', 'classiadspro').'"><span class="style1 unchecked fas fa-heart"></span></a>';
				}elseif($style == 2){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Bookmark', 'classiadspro').'"><span class="style2 unchecked fas fa-heart"></span></a>';
				}elseif($style == 3){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Bookmark', 'classiadspro').'"><span class="style3 unchecked fas fa-bookmark"></span></a>';
				}elseif($style == 4){
					$link = '<a id="'.$listing->post->ID.'" href="javascript:void(0);" class="add_to_favourites btn simptip simptip-position-top simptip-movable" data-listingid="'.$listing->post->ID.'" data-tooltip="'. esc_attr__('Bookmark', 'classiadspro').'"><span class="style4 unchecked far fa-bookmark"></span><span class="bookmark-text">'. esc_html__('bookmark', 'classiadspro') .'</span></a>';
				}
				$hear_icon = 'heart';
