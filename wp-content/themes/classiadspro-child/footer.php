...
<div class="popup-wrapper">
	<div class="popup">
		...
		<iframe width="800" height="600" src="https://www.youtube.com/embed/nqye02H_H6I?autoplay=1&mute=1&loop=1&controls=0&showinfo=0" frameborder="0" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	</div>
</div>
<script>
	jQuery(document).ready(function(){
		jQuery("#demo_video").click(function(){
